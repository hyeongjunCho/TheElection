<template>
    <Page ref="page" class="page" @loaded="pageLoaded" actionBarHidden="true" width="100%" height="100%">
                ...
                this.$store.dispatch('resetSupportingCandidate')
                    .then(() => {
                        ...
                        .then(() => {
                            ...
                            this.svgBusanColor = this.partyColors[Math.ceil(this.makeSortedRatings(this.$store.getters.getRegionRatings('Busan'))[0].candidate / 3)];
                            this.svgDaeguColor = this.partyColors[Math.ceil(this.makeSortedRatings(this.$store.getters.getRegionRatings('Daegu'))[0].candidate / 3)];
                            this.svgDaejeonColor = this.partyColors[Math.ceil(this.makeSortedRatings(this.$store.getters.getRegionRatings('Daejeon'))[0].candidate / 3)];
                            this.svgGangwonColor = this.partyColors[Math.ceil(this.makeSortedRatings(this.$store.getters.getRegionRatings('Gangwon'))[0].candidate / 3)];
                            this.svgGwangjuColor = this.partyColors[Math.ceil(this.makeSortedRatings(this.$store.getters.getRegionRatings('Gwangju'))[0].candidate / 3)];
                            this.svgGyeonggiColor = this.partyColors[Math.ceil(this.makeSortedRatings(this.$store.getters.getRegionRatings('Gyeonggi'))[0].candidate / 3)];
                            this.svgIncheonColor = this.partyColors[Math.ceil(this.makeSortedRatings(this.$store.getters.getRegionRatings('Incheon'))[0].candidate / 3)];
                            this.svgJejuColor = this.partyColors[Math.ceil(this.makeSortedRatings(this.$store.getters.getRegionRatings('Jeju'))[0].candidate / 3)];
                            this.svgNorthChungcheongColor = this.partyColors[Math.ceil(this.makeSortedRatings(this.$store.getters.getRegionRatings('NorthChungcheong'))[0].candidate / 3)];
                            this.svgNorthGyeongsangColor = this.partyColors[Math.ceil(this.makeSortedRatings(this.$store.getters.getRegionRatings('NorthGyeongsang'))[0].candidate / 3)];
                            this.svgNorthJeollaColor = this.partyColors[Math.ceil(this.makeSortedRatings(this.$store.getters.getRegionRatings('NorthJeolla'))[0].candidate / 3)];
                            this.svgSejongColor = this.partyColors[Math.ceil(this.makeSortedRatings(this.$store.getters.getRegionRatings('Sejong'))[0].candidate / 3)];
                            this.svgSeoulColor = this.partyColors[Math.ceil(this.makeSortedRatings(this.$store.getters.getRegionRatings('Seoul'))[0].candidate / 3)];
                            this.svgSouthChungcheongColor = this.partyColors[Math.ceil(this.makeSortedRatings(this.$store.getters.getRegionRatings('SouthChungcheong'))[0].candidate / 3)];
                            this.svgSouthGyeongsangColor = this.partyColors[Math.ceil(this.makeSortedRatings(this.$store.getters.getRegionRatings('SouthGyeongsang'))[0].candidate / 3)];
